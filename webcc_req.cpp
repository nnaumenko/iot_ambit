...
int HTTPStream::read() {
  ...
  if (((i == CR) && (this->previousChar == LF)) || ((i == LF) && (this->previousChar == CR))) i = this->client->read();
  if (i == NOT_AVAILABLE) return (NOT_AVAILABLE);
  this->previousChar = i;
  if (i == CR) i = LF;
  return (i);
...
int HTTPStream::peek() {
  ...
  if (i == NOT_AVAILABLE) return (NOT_AVAILABLE);
  if (((i == CR) && (this->previousChar == LF)) || ((i == LF) && (this->previousChar == CR))) {
    this->client->read();
    i = this->client->peek();
  }
  if (i == NOT_AVAILABLE) return (NOT_AVAILABLE);
...
void HTTPStreamHelper::readUntil(Stream &client, const char * charsToFind, char * buffer, size_t bufferSize) {
  ...
  for (size_t bufferPos = 0; bufferPos < (bufferSize - 1); bufferPos++) {
    ...
    int i = client.peek();
    if (i == HTTPStream::NOT_AVAILABLE) return;
    char c = (char) i;
...
const PROGMEM HTTPReqParserStateMachine::TransitionTableEntry HTTPReqParserStateMachineTransitionTableInit[] = {
  ...
  { HTTPReqParserStateMachine::ParserState::UNKNOWN,              HTTPReqParserStateMachine::CHAR_OTHER,    HTTPReqParserStateMachine::ParserState::FINISHED,                HTTPStatusCode::INTERNAL_SERVER_ERROR},
  ...
  { HTTPReqParserStateMachine::ParserState::METHOD,               HTTPReqParserStateMachine::CHAR_OTHER,    HTTPReqParserStateMachine::ParserState::FINISHED,                HTTPStatusCode::BAD_REQUEST},
  ...
  { HTTPReqParserStateMachine::ParserState::PATH,                 HTTPReqParserStateMachine::CHAR_OTHER,    HTTPReqParserStateMachine::ParserState::FINISHED,                HTTPStatusCode::BAD_REQUEST},
  ...
  { HTTPReqParserStateMachine::ParserState::URL_QUERY_NAME,       HTTPReqParserStateMachine::CHAR_OTHER,    HTTPReqParserStateMachine::ParserState::FINISHED,                HTTPStatusCode::BAD_REQUEST},
  ...
  { HTTPReqParserStateMachine::ParserState::URL_QUERY_VALUE,      HTTPReqParserStateMachine::CHAR_OTHER,    HTTPReqParserStateMachine::ParserState::FINISHED,                HTTPStatusCode::BAD_REQUEST},
  ...
  { HTTPReqParserStateMachine::ParserState::HTTP_VERSION,         HTTPReqParserStateMachine::CHAR_OTHER,    HTTPReqParserStateMachine::ParserState::FINISHED,                HTTPStatusCode::BAD_REQUEST},
  ...
  { HTTPReqParserStateMachine::ParserState::FIELD_NAME,           HTTPReqParserStateMachine::CHAR_OTHER,    HTTPReqParserStateMachine::ParserState::FINISHED,                HTTPStatusCode::BAD_REQUEST},
  ...
  { HTTPReqParserStateMachine::ParserState::FIELD_VALUE,          HTTPReqParserStateMachine::CHAR_OTHER,    HTTPReqParserStateMachine::ParserState::FINISHED,                HTTPStatusCode::BAD_REQUEST},
  ...
  { HTTPReqParserStateMachine::ParserState::HEADER_END,           HTTPReqParserStateMachine::CHAR_OTHER,    HTTPReqParserStateMachine::ParserState::FINISHED,                HTTPStatusCode::BAD_REQUEST},
  ...
  { HTTPReqParserStateMachine::ParserState::POST_QUERY_NAME,      HTTPReqParserStateMachine::CHAR_OTHER,    HTTPReqParserStateMachine::ParserState::FINISHED,                HTTPStatusCode::BAD_REQUEST},
...
void HTTPReqParserStateMachine::parse(void) {
  ...
  switch (this->processingTable.getStreamOperation()) {
    ...
    case StreamOperation::READ:
      ...
      HTTPStreamHelper::readUntil(*this->client, nextChars, readBuffer, READ_BUFFER_SIZE);
      if (strlen(readBuffer) > HTTP_REQUEST_PART_MAX_SIZE) {
        this->setStatusCode(HTTPStatusCode::REQUEST_URI_TOO_LONG);
        return;
      }
    ...
    case StreamOperation::SKIP:
      this->transitionTable.enumerateNextChars(this->parserStatus.currentState, nextChars, NEXT_CHARS_SIZE);
      HTTPStreamHelper::readUntil(*this->client, nextChars, NULL, 0);
      nextCharAsInt = this->client->read();
      break;
...
void HTTPReqParserStateMachine::transition(HTTPReqParserStateMachine::ParserState newState, HTTPStatusCode newStatusCode) {
  ...
  if (newStatusCode != HTTPStatusCode::NO_CHANGE) parserStatus.statusCode = newStatusCode;
}

boolean HTTPReqParserStateMachine::isFinished(void) {
  return (parserStatus.requestPart == HTTPRequestPart::FINISH);
}

void HTTPReqParserStateMachine::setStatusCode(HTTPStatusCode newStatusCode) {
  if (newStatusCode == HTTPStatusCode::NO_CHANGE) return;
  const HTTPStatusCode errorStatusCodes = (HTTPStatusCode) 400;
  if (newStatusCode >= errorStatusCodes)
    transition(ParserState::FINISHED, newStatusCode);
  else
    parserStatus.statusCode = newStatusCode;
}

boolean HTTPReqParserStateMachine::isError(void) {
  const HTTPStatusCode errorStatusCodes = (HTTPStatusCode) 400;
  return (parserStatus.statusCode >= errorStatusCodes);
}

HTTPStatusCode HTTPReqParserStateMachine::getStatusCode(void) {
  return (parserStatus.statusCode);
}

const char * HTTPReqParserStateMachine::getReqPartValue(void) {
  return (readBuffer);
}

HTTPRequestPart HTTPReqParserStateMachine::getReqPart(void) {
